...
#===============================================================================
# ■ XAS Hero Edition ACE (Ver Experimental 0.5  - 2012 / 01 / 04)                                                 
#===============================================================================
...
#===============================================================================
  (V 0.5)
   - introdução inicial do XAS Hero Edition para o Rpg Maker VX ACE.
   - Versão de teste para correção de bugs, glitches e teste de performance.
=end
...
#-------------------------------------------------------------------------------
module XAS_SYSTEM
  # Ativar o sistema de batalha, deixe como false se desejar usar apenas o 
  # sistema de ferramentas (Interação com o cenário)
  # Caso queira desativar o sistema de batalha durante o jogo use o comando
  # abaixo.
  #
  ...
  DAMAGE_POP = true
  # Ativar o sistema de pose de ações.
  CHARACTER_POSE_NAME = true
  # Ativar o sistema de sprites
  CHARACTER_SPRITE_EFFECTS = true
  # Ativar o sistema de dash avançado para o XAS.
  DASH_SYSTEM = true
  # Ativar o sistema de diagonal para o player.
  PLAYER_DIAGONAL_MOVEMENT  = true
  # Ativar o sistema de diagonal para o evento
...
module XAS_BUTTON
  ...
  #Definição do botão do escudo.
  ACTION_2_BUTTON = Input::X
  #Definição do botão de habildiade
  SKILL_BUTTON = Input::Z  
  #Definição do botão do item.
  ITEM_BUTTON = Input::Y
  #Definição do botão de correr.
  DASH_BUTTON = Input::A
  #Definição do botão de mudar de lider.
  CHANGE_LEADER_BUTTON = Input::R
  #Ativar o botão de ataque.
  ENABLE_ACTION_1_BUTTON = true
  #Ativar o botão de escudo.  
  ENABLE_ACTION_2_BUTTON = true
  #Ativar o botão de habilidade.
  ENABLE_SKILL_BUTTON = true
  #Ativar o botão de item.
  ENABLE_ITEM_BUTTON = true
  #Ativar o botão de corrida. 
  ENABLE_DASH_BUTTON = true
  #Ativar o botão de mudar de lider.  
...
module XAS_WORD
  ...
  LEVEL_UP = "Level Up"
  # Palavra usada quando o personagem está com as ações seladas.
  SEAL = "Sealed!"
  # Palavra usada quando o personagem está invencível.
  ...
  COUNTER = "Counter"
  # Palavra usada quando a habilidade é refletida.
  REFLECT = "Reflected"
end
...
module XAS_SOUND
  ...
  ITEM_DROP = "Key" 
  #Som executado ao fazer level up
  LEVEL_UP = "Chime1"
...
module XAS_ANIMATION
  ...
  # Animação quando o lider é trocado.
  CHANGE_LEADER_ANIMATION_ID = 135
  # Animação quando o battler acerta o alvo em condição invencível.
  ...
  # Velocidade do loop das animações.
  LOOP_ANIMATIONS_SPEED = 60
  # Animação de refletir
...
#-------------------------------------------------------------------------------
module XAS_BA
  #Tempo para poder ativar o botão de mudar de lider.
  CHANGE_LEADER_WAIT_TIME = 10
  #Deixar a hud visivel ao começar o jogo.
  #Você pode ativar ou desativar a hud usando o código abaixo
  # $game_system.hud_visible = true
  HUD_VISIBLE_AT_STARTUP = false
  # Definição da Switch da página de ações de curta distância. 
  SENSOR_SELF_SWITCH = "D"
  # Definição da variável que define a area padrão para ativar a página de
  # ações de curta distância.
  ...
  # Velocidade básica de movimento
  BASE_MOVE_SPEED = 4.2
  # Velocidade extra quando o battler estiver correndo.
  DASH_MOVE_SPEED = 0.6
  # Retornar na posição de 4 direções após algum tempo na posição na diagonal. 
  DIAGONAL_DURATION_ENABLE = true
  # Tempo para retornar na posição de 4 direções.
  DIAGONAL_DURATION = 15
  # Definição do modo como a experiência é dividida entre os aliados.
  # 0 - EXP somente para quem matou o inimigo.
  ...
  # Ativar a animação de fade no tesouro.
  FADE_TREASURE_SPRITE = true
  # Ativar a animação de levitação no tesouro.
...
module XAS_BA_ENEMY
  ...
  # Definição das direções que o inimigo será invunerável.
  # GUARD_DIRECTIONS = { A=>[B],  A=>[B,B,B,B], ...}
  # A - ID do inimigo 
  # B - Direções de Invulnerabilidade. 
  #     -> 2 = Abaixo.   -> 4 = Esquerda.
  #     -> 6 = Direita.  -> 8 = Acima. 
  GUARD_DIRECTIONS = {
  }  
